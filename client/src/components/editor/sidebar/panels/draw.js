    ...
    <div className="p-4">
      <div className="space-y-5">
        <Button
          ...
          className={"w-[16 0px]  group transition-all flex items-center p-0.5 "}
          size="lg"
        ...
        {isDrawingMode && (
          <>
            ...
            >
              <TabsList className={"grid grid-cols-1 sm:grid-cols-3 mb-15 sm:mb-4"}>
