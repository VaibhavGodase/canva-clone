...
function SubscriptionModal({ isOpen, onClose }) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className={"sm:max-w-[900px] h-[360px] sm:h-auto p-0 gap-0 overflow-scroll sm:overflow-hidden"}>
        <div className="flex flex-col md:flex-row">
          ...
          <div className="hidden md:block md:w-[450px]">
            <img
              src="https://www.wellright.com/hubfs/team-collaboration-blog.jpg"
